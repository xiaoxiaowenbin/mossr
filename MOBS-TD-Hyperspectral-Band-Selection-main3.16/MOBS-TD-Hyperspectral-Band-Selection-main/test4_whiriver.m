%% MOSSR Algorithm - PSO Engine Version (WHU-Hi-River 适配版)
% 核心思想：
...
for runIdx = 1:nRuns
    ...
    for it = 1:MaxT
        ...
        for i = 1:nPop
            ...
            pop(i).Velocity = w*pop(i).Velocity + c1*rand(VarSize).*(pop(i).Best.Position-pop(i).Position) ...
    ...
    % 调用 MOSSR 的投票函数
    final_selected_bands = select_bands_test3(x_rep, f_rep, L, K, snr_vec);
